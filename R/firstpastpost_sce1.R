...
saveRDS(resall0, paste0(out, "sce1_one.rds"))
...
saveRDS(resall0, paste0(out, "sce1_three.rds"))





resall0 %>% select("interim", "superior", "futile", starts_with("n.")) %>% summarise_all(mean)
